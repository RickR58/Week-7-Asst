...
let sum = 0;
console.log("Ages:", ages); //added the "Ages" text to the console log for clarity.
...
let result = ages[ages.length - 1] - ages[0]; //used index numbers to subtract the 3 in the array from the ending 66 in the array
console.log("The last age minus the first age is: " + result); //added the text to the console log for clarity here and throughout the assignment.

console.log(
  "1-b. Add a new age to your array and repeat the step above to ensure it is dynamic. (works for arrays of different lengths"
);
console.log("I added a new age — 66 — to the array on line 4"); //added an age to the original array to test.

console.log(
  "1-c. Use a loop to iterate through the array and calculate the average age."
);
for (let i = 0; i < ages.length; i++) {
  sum += ages[i]; //Adds ages to the sum
  // DEBUG: this showed where the 299 number came from --->> console.log(sum) Did some debug work with mentor;
}
...
let concatenatedNames = names.join(" "); //Concatenated the previous names list using names.join plus a space " ".
console.log(concatenatedNames);

console.log("3. How do you access the last element of any array?");
/* let ages = [3, 9, 23, 64, 2, 8, 28, 66, 93];
let lastNum = ages.findLast((element) => element > 12);*/
console.log("By using variable.findLast");

console.log("4. How do you access the first element of any array?");
console.log("By using an index number of 0");
...
function repeatWord(word, n) {
  return word.repeat(n); //used .repeat to create the return
}
console.log(repeatWord("Hello", 7)); //In this case, the 7 says how many times to repeat the word
...
console.log("John", "Jones"); // Can't say much here. Pretty simple
...
const nums = [10, 5, 20, 15, 30, 25, 40, 45]; //badda bing, badda boom, and bob's yer uncle. I can change nums and get a different average.
...
function willBuyDrink(isHotOutside, moneyInPocket) {
  return isHotOutside && moneyInPocket > 10.5; // && returns true only if both are true
}
console.log(willBuyDrink(true, 10.49)); // 1¢ more returns True

console.log(
  "13. Create a function of your own that solves a problem. In comments, write what the function does and why you created it."
);

//This function solves this problem: If 1.3 lbs of turkey will feed 1 person, how many friends can I feed with one X-lb turkey?
